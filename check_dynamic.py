        ...
        try:
            if item["type"] == 'DYNAMIC_TYPE_AV':
                ...
                items.append({
                    ...
                    "description": f"<img src='{video_info['cover']}'/><p>介绍：{video_info['desc']}</p><p>地址：<a href=https://www.bilibili.com/video/{video_info['bvid']}>https://www.bilibili.com/video/{video_info['bvid']}</a></p>",
                    "pub_date": pub_date,
